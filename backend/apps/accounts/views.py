...
tags = ["Accounts"] # для расширения функиионала документации OpenAPI для View
...
class RegisterView(generics.CreateAPIView): # метод post уже внутри CreateAPIView
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response({
            'user': UserProfileSerializer(new_user).data, # ссериализаци итоговых яданных 
            # 'refresh': str(refresh),
