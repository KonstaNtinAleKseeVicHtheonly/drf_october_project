...
urlpatterns = [
    ...
    path('categories/<slug:category_slug>/posts/', views.post_by_category, name='posts-by-category'), # посты по заданной категории
    ...
    # path('featured/', views.featured_posts, name='featured-posts'), # пока не сделано
